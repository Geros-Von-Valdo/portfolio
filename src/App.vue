  ...
  <header class="fixed top-0 right-0 p-4 flex items-center gap-2 group">
    <div class="relative">
      ...
      <div class="highlight absolute top-0 right-full flex flex-row items-center space-x-2">
        ...
        <div
          class="corSecundaria relative flex items-center h-8 border-2 rounded-full transition-all duration-300 cursor-pointer
            
            transform translate-x-full opacity-0 pointer-events-none group-hover:translate-x-0 group-hover:opacity-100 group-hover:pointer-events-auto">
          <select ref="sel" v-model="currentLang" @change="changeLanguage" class="
      ...
      <section class="mt-20 max-w-4xl mx-auto px-4">
        ...
        <div class="relative border-l-2 border-gray-300 border-gray-300 pl-10 space-y-14">
          ...
          <div class="relative">
            ...
            <span class="absolute -left-5 top-[2px] w-3 h-3 bg-gray-500 dark:bg-gray-400 rounded-full"
          ...
          <div class="relative">
            ...
            <p class="text-xs uppercase tracking-widemb-1">
              Graduação
            </p>
            <h3 class="text-2xl font-semibold">
